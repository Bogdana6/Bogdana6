$(document).ready(function () {
  ...
  prevBtn.innerHTML = `
  <object class="arrow" data="./7.svg" type="image/svg+xml"></object>
  `;

  nextBtn.innerHTML = `
  <object class="arrow" data="./8.svg" type="image/svg+xml"></object>
  `;

  nextBtn.addEventListener('click', function () {
    this.classList.add('animationNext');
    setTimeout(() => this.classList.remove('animationNext'), 1050);
  });

  prevBtn.addEventListener('click', function () {
    this.classList.add('animationPrev');
    setTimeout(() => this.classList.remove('animationPrev'), 1050);
  });
